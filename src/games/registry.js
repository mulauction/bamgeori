...
import mines from './mines/index.js';
...
const MODULES = [yabawi, dograce, cockfight, holjjak, rps, ladder, jebi, coinflip, hilo, dice, wheel, plinko, keno, tower, limbo, mines, crash, workDaeri, shop];
